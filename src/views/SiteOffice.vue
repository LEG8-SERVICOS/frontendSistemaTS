    ...
    <header class="relative z-50 w-full h-24">
      <div class="container flex items-center justify-center h-full max-w-6xl px-8 mx-auto sm:justify-between xl:px-0">
        <a href="/" class="relative flex items-center inline-block h-5 h-full font-black leading-none">
          ...
          <span class="ml-3 text-xl text-gray-800">Leg8 Serviços<span class="text-orange-500">.</span></span>
        </a>

        <nav id="nav"
          class="absolute top-0 left-0 z-50 flex flex-col items-center justify-between hidden w-full h-64 pt-5 mt-24 text-sm text-gray-800 bg-white border-t border-gray-200 md:w-auto md:flex-row md:h-24 lg:text-base md:bg-transparent md:mt-0 md:border-none md:py-0 md:flex md:relative">
          <a href="#"
            class="ml-0 mr-0 font-bold duration-100 md:ml-12 md:mr-3 lg:mr-8 transition-color hover:text-orange-600">Home</a>
          <a href="#features"
            class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-orange-600">Nossa História</a>
          <a href="#testimonials" class="font-bold duration-100 transition-color hover:text-orange-600">Feedback</a>
          <div class="flex flex-col block w-full font-medium border-t border-gray-200 md:hidden"></div>
        </nav>
        ...
        <div id="nav-mobile-btn" @click="toggleNav"
      ...
      <div
        ...
        <div
          ...
          <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">
            Nossos serviços na indústria são projetados para ajudar nossos clientes a alcançar os mais altos níveis de
            qualidade em seus produtos e processos. Tanto em seu parque fabril como no endereço de seus clientes.
            Utilizamos ferramentas e metodologias comprovadas para garantir que cada etapa do processo de produção seja
            executada com a máxima qualidade e eficiência
          </p>
          <a href="https://wa.me/5547984074659"
            class="z-10 relative self-start inline-block w-auto px-8 py-4 mx-auto mt-0 text-base font-bold text-white bg-orange-600 border-t border-gray-200 rounded-md shadow-xl sm:mt-1 fold-bold lg:mx-0">Entre
            em contato!</a>
          <!-- Integrates with section -->
          <div class="flex-col hidden mt-12 sm:flex lg:mt-24">
            <p class="z-10 mb-4 text-sm font-medium tracking-widest text-gray-500 uppercase">
              Nossos Clientes:
            </p>
          </div>
        ...
        <div class="relative z-50 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10">
          <div class="container relative left-0 w-full max-w-4xl lg:absolute xl:max-w-6xl lg:w-screen">
            <img src="../assets/leg8-mockup.png"
      ...
      <div class="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
        ...
        <div class="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
          <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
            ...
            <li>
              <a href="#_" class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Features</a>
            </li>
            <li>
              <a href="#_" class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Integrations</a>
            </li>
            <li>
              <a href="#_" class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Pricing</a>
            </li>
            <li>
              <a href="#_" class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">FAQ</a>
            </li>
          </ul>
          <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
            <li class="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
            ...
            <li>
              <a href="#_" class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Terms of
                Service</a>
            </li>
          </ul>
          <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
            ...
            <li>
              <a class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Tailwind Components</a>
            </li>
            <li>
              <a class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Tailwind Templates</a>
            </li>
            <li>
              <a class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Tails</a>
            </li>
          </ul>
