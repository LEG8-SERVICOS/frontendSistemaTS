      ...
      <main class="p-6 sm:p-10 space-y-6">
        ...
        <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
          ...
          <div class="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <div>
              <span class="block text-2xl font-bold">{{ totalOperadores }}</span>
              <span class="block text-gray-500">Numero de Operadores</span>
            </div>
          </div>
          <usersProdutivity />
          <topCampaings />
...
import modalUsersRegister from '@/components/modals/modalUsersRegister.vue';
